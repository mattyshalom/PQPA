...
<head>
  ...
  <title>Sign Up - PQPA</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="assets/img/PQPA favicon.png" rel="icon">
  <link href="assets/img/PQPA-touch-icon.png" rel="apple-touch-icon">
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  <img src="assets/img/PQPA-touch-icon.png" alt="">
                </a>
              </div><!-- End Logo -->
                  ...
                  <form action="signup.php" method="post" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        <input class="form-check-input check-it" name="terms" type="checkbox" value="" id="acceptTerms" required>
      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-2 col-6 footer-links">
          ...
          <ul>
            ...
            <li><a href="#">Take a test demo</a></li>
          </ul>
        </div>
      </div>
    </div>
